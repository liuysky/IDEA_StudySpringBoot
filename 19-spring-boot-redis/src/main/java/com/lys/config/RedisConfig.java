...
//        config.setMaxTotal(20);
    ...
    public JedisConnectionFactory jedisConnectionFactory(JedisPoolConfig config) {
        ...
        //配置连接redis的信息
        //主机地址
//        factory.setHostName("134.175.5.228");
//        //端口
//        factory.setPort(6379);
//        factory.setDatabase(10);

        System.out.println("设置后："+config.getMaxIdle());
        System.out.println("设置后："+config.getMinIdle());
        System.out.println("设置后："+config.getMaxTotal());
